...
map.del("n", "<leader>l")
map.del("n", "<leader>L")
map.set("n", "<leader>mm", "<cmd>Mason<CR>", { desc = "Package Manager - [Mason]" })
map.set("n", "<leader>ml", "<cmd>Lazy<CR>", { desc = "Plugin Manager - [LazyVim]" })
map.set("n", "<leader>me", "<cmd>LazyExtras<cr>", { desc = "Extras Manager - [LazyVim]" })
map.set("n", "<leader>mo", Util.news.changelog, { desc = "Changelog [LazyVim]" })
map.set("n", "<leader>mi", "<cmd>LspInfo<cr>", { desc = "Lsp Info" })
map.set("n", "<leader>mr", Util.root.info, { desc = "Root Info [LazyVim]" })
map.set("n", "<leader>md", vim.cmd.messages, { desc = "Display messages" })
map.set("n", "<leader>mt", "<cmd>TSModuleInfo<cr>", { desc = "Display messages" })
