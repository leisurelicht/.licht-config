...
return {
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map.set("n", "<leader>gc", Utils.telescope("git_bcommits"), "Buffer's Commits", { buffer = bufnr })
        map.set("n", "<leader>gs", Utils.telescope("git_stash"), "Stash", { buffer = bufnr })
        map.set("n", "<leader>gn", Utils.telescope("git_branches"), "Branches", { buffer = bufnr })
      end,
    },
  },
}
